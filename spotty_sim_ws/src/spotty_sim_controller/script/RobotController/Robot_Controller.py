...
from RobotController.State_Command import State, Command, BehaviorState
from RobotController.Rest_Controller import Rest_controller
...
class Robot(object):
    def __init__(self, body, legs, imu):
        ...
        self.x_shift_front = -0.028
        self.x_shift_back = -0.068
        self.default_height = 0.16

        self.restController = Rest_controller(self.default_stance)
